...
import pic1 from "../../../assets/articles/mczukunft/1.png";

function KeinFleischMehr() {
    return (
        <article className="article">
            <h1 className="title">Was wenn niemand mehr Fleisch essen will?</h1>
            ...
            <br />
            <p className="paragraphovertitle">
            Werden Vegetarismus und Veganismus zum Standard?

            </p>
            <br />
            <p>
            Das wird mit grösster Wahrscheinlichkeit nicht passieren, denn solch grundlegende Änderungen dauern länger als zehn Jahre. Wenn der Trend des Vegetarismus und Veganismus aber weitgehend zunimmt, hat McDonald’s die Herausforderung, diese Gruppe an Personen weiter für sich zu gewinnen, wenn auch mit vegetarischen oder veganen Produkten.
            ...
            <br />
            <p>
            Das bedeutet also, dass eine solche Bewegung schon kommt und der McDonald’s den Megatrend bereits wahrnimmt und versucht für eine solche Zielgruppe ein Angebot zu kreieren. Nicht zuletzt, weil viele dieser Vegetarier:innen und Veganer:innen einer jungen Zielgruppe angehören (Swissveg, 2017). Diese junge Zielgruppe ist eher eine Zielgruppe, welche sich untreu gegenüber McDonald’s verhält. Wenn also die Konkurrenz beginnt bessere oder überhaupt vegetarische beziehungsweise vegane Produkte zu verkaufen, so zieht dies auch die Zielgruppe der Fleischessenden mit sich. 
            ...
            <p className="paragraphovertitle">
            Künstlich produziertes Fleisch ersetzt das richtige Fleisch?
...
<br />
            ...
            <p>
            Wenn der Trend der vegetarischen und veganen Produkte stagniert oder sogar zurückgeht, aber künstlich hergestelltes Fleisch immer mehr in den Fokus der Leute gerät, weil der Geschmack, die Konsistenz etc. von Fleisch für eine Mehrheit der Konsument:innen zu wichtig ist, so wird dies sich doch anders auf das Marketing auswirken, als wenn vegetarische/vegane Produkte den grösseren Trend darstellen. 
            ...
            <br />
            <p>
            Die Werbung hierbei fokussiert sich im Vergleich zur Veränderung von Szenario 1 mehr darauf, dass der Geschmack dieses Fleisches gleich ist, wie der von herkömmlichem Fleisch.
...
export default KeinFleischMehr
