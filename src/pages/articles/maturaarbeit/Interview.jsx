...
export default function Interview() {
    return (
        <article className="article">
            ...
            So trafen wir uns, online, und führten ein sehr informatives Gespräch. Es klärten sich unsere Fragen und wir wussten wie jetzt in die Zukunft geforscht wird. (Zukunftsforschung)
            </p>
            </div>
            <img src={pic1} alt=""/>
            </div>
            ...
            Wir trafen uns erneut auf Zoom für ein 45 Minuten langes, interessantes Gespräch. Nicht nur, konnte Herr Schäppi uns mit einzelnen Theorien klarheit geben, sondern auch spezifisch auf McDonald’s bezogene Beispiele erklären. Ein wichtiger, weiterer Schritt zur Erstellung der Artikel und das Verständnis des riesigen Konstrukts, welches wir uns vornahmen zu beleuchten.
            </p>
            </div>
            </div>
        </article>
