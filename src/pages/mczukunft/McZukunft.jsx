    ...
    return (
        <div className="mcMarketing">
            ...
            <div className="emptyBox">
                ...
                <p className="heroText">Eine Erklärung, wie wir auf die Ergebnisse der anderen Artikel von McZukunft gekommen sind </p>
            ...
            <div className="top">
                ...
                <div className="textOverImg">
                    ...
                    <p className="heroText">Szenarien, wie die Zukunft des McMarketing in Anbetracht auf das Klima werden könnte</p>
